...
abstract class Logger extends BaseObject {
     ...
     * @return $this
     */
    public abstract function trace($message, $context = []);
     ...
     * @return $this
     */
    public abstract function info($message, $context = []);
     ...
     */
    public abstract function createChild($childName);
